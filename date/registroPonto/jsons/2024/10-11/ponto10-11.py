...
OUTPUT_FILE = os.path.join(BASE_DIR, "ponto10-11.json")

url = f"{os.environ['HR_API_BASE_URL'].rstrip('/')}/external_api/v1/reports/time_cards"
headers = {
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                error_message = (f"Erro na requisição: {response.status_code}. Detalhes: {response.text} "
                                 f"Arquivo: ponto10-11.py, Hora: {error_time}")
