...
url = "https://api.pontomais.com.br/external_api/v1/holidays?attributes=id,name,fixed,date,active,team,department,business_unit,cost_center,shift&count=1&page=1&per_page=99999999999999"
headers = {
...
def main():
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            output_path = os.path.join(BASE_DIR, "feriados_register.json")
            ...
            error_message = (f"Erro na requisição: {response.status_code}. Detalhes: {response.text} "
                           f"Arquivo: feriados_register.py, Hora: {error_time}, "
