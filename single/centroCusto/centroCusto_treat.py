...
json_file = os.path.join(BASE_DIR, "centroCusto_register.json")
...
def main():
    ...
    logging.info(f"Iniciando processamento do centroCusto_treat.py às {start_time}")
    ...
    try:
        ...
        cost_centers = json_data['cost_centers']
        normalized_data = []

        for center in cost_centers:
            item = {
                'Codigo': center.get('code', ''),
                'Nome': center.get('name', '')
            }
