...
url = "https://api.pontomais.com.br/external_api/v1/reports/teams"
headers = {
...
def main():
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            output_path = os.path.join(BASE_DIR, "equipes_register.json")
            ...
            error_message = (f"Erro na requisição: {response.status_code}. Detalhes: {response.text} "
                           f"Arquivo: equipes_register.py, Hora: {error_time}, "
