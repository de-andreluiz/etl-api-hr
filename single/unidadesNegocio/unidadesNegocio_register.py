...
url = "https://api.pontomais.com.br/external_api/v1/business_units?page=1&per_page=99999"
headers = {
...
def main():
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            output_file = os.path.join(BASE_DIR, "unidadesNegocio_register.json")
            ...
            error_message = (f"Erro na requisição: {response.status_code}. Detalhes: {response.text} "
                           f"Arquivo: unidadesNegocio_register.py, Hora: {error_time}, "
